...
public class FeedReaderDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedReaderContract.FeedEntry.TABLE_NAME + " (" +
                    ...
                    FeedReaderContract.FeedEntry.COLUMN_NAME_NRP + " TEXT," +
    ...
    public void insertData(
        ...
        values.put(FeedReaderContract.FeedEntry.COLUMN_NAME_NRP, nrp);
...
//    }
    ...
    public void deleteData(String nrp) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(FeedReaderContract.FeedEntry.TABLE_NAME, FeedReaderContract.FeedEntry.COLUMN_NAME_NRP + " = ?", new String[]{nrp});
    }
    ...
    public void updateData(
        ...
        values.put(FeedReaderContract.FeedEntry.COLUMN_NAME_GENDER, gender);
        values.put(FeedReaderContract.FeedEntry.COLUMN_NAME_ADDRESS, address);
        db.update(FeedReaderContract.FeedEntry.TABLE_NAME, values, FeedReaderContract.FeedEntry.COLUMN_NAME_NRP + " = ?", new String[]{nrp});
    }
